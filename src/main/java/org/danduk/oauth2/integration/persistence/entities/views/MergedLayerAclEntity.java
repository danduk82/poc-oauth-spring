...
public class MergedLayerAclEntity {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(pk, that.pk) && Objects.equals(userEmail, that.userEmail) && Objects.equals(userId, that.userId) && Objects.equals(id, that.id) && Objects.equals(fkServerId, that.fkServerId) && Objects.equals(name, that.name) && Objects.equals(title, that.title) && Objects.equals(matrixset, that.matrixset) && Objects.equals(queriable, that.queriable);
    }

    @Override
    public int hashCode() {
        return Objects.hash(pk, userEmail, userId, id, fkServerId, name, title, matrixset, queriable);
    }
}
